...
export default function Home() {
  ...
  return (
    ...
    bg-gradient-to-br from-[#1E1145] via-[#110826] to-[#0A0416] p-6 text-white relative overflow-hidden">
      
      <div className="absolute top-20 left-20 w-96 h-96 bg-purple-600/20 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-indigo-600/20 rounded-full blur-[100px] pointer-events-none"></div>
      <h1 className="text-5xl font-extrabold mb-6 flex gap-3 items-center animate-float">
